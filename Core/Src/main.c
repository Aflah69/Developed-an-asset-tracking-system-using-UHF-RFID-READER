...
/* Private typedef -----------------------------------------------------------*/
/* USER CODE BEGIN PTD */
#define MAX_RFID_DATA_SIZE 100
/* USER CODE END PTD */
// Array to store received RFID data
uint8_t rfidData[MAX_RFID_DATA_SIZE];

// Variables for hexadecimal conversion
char hexBuffer[MAX_RFID_DATA_SIZE * 2 + 1];
/* Private define ------------------------------------------------------------*/
/* USER CODE BEGIN PD */
